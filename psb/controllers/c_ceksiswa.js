...
// main function ---
    $(document).ready(function(){
        contentFR += '<form autocomplete="off" onsubmit="simpan();return false;" id="'+mnu+'FR">' 
                        ...
                        // ceksiswa
                        +'<label>ceksiswa</label>'
                        +'<div class="input-control text">'
                            +'<input required placeholder="ceksiswa" name="ceksiswaTB" id="ceksiswaTB">'
        ...
        //search action
        $('#ceksiswaS,#keteranganS').keydown(function(e){
